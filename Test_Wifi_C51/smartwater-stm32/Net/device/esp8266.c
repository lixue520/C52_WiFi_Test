...
#define WIFI_SSID 						"mywater"								//	WIFI的名称 必须用2.4G的wifi不能用5G的，且不能用中文、空格
#define WIFI_PSWD 						"220220220"				//	WIFI密码

#define SERVER_HOST						"www.qzwxixi.cn"			//	MQTT服务器域名或IP
...
void ESP8266_Init(void)
{
	...
	//ESP8266复位引脚.
	GPIO_Initure.GPIO_Pin = GPIO_Pin_6;					//GPIOB6-复位
